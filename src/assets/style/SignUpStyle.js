...
const SignUpStyle = StyleSheet.create({
  ...
  childView: {flex: 1, alignItems: 'center', justifyContent: 'flex-start', paddingTop: wp('10')},
  ...
  inputStyle: {width: wp('36'),height: hp('6'),fontFamily: 'Poppins-Medium',fontSize: wp('3'),color: 'white',},
  lineStyle: {width: wp('36'),height: wp('0.3'),backgroundColor: '#A6A6A6'},
  inputStyle1: {width: wp('85'),height: hp('6'),fontFamily: 'Poppins-Medium',fontSize: wp('3'),color: 'white'},
