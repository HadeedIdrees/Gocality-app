...
const ForgotPasswordStyle = StyleSheet.create({
    ...
    inputStyle: {width: wp('75'),height: hp('6'),fontFamily: 'Poppins-Medium',fontSize: wp('3'),color: 'white',},
    ...
    buttonStyle: {width: wp('10'), height: wp('10'), borderRadius: wp('10'), backgroundColor: 'white', alignItems: 'center', justifyContent: 'center'},
