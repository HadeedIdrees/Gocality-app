...
const LoginStyle = StyleSheet.create({
    ...
    subHeadingText: {fontSize: wp('3'),color: 'white',fontFamily: 'Poppins-Light',},
    ...
    inputStyle: {width: wp('80'),height: hp('6'),fontFamily: 'Poppins-Medium',fontSize: wp('3'),color: 'white',},
    inputStyle2: {width: wp('75'),height: hp('6'),fontFamily: 'Poppins-Medium',fontSize: wp('3'),color: 'white',},
    ...
    buttonTextColor: {fontFamily: 'Poppins-Bold',fontSize: wp('4'),color: 'white',},
    forgotViewStyle: {width: wp('90'), paddingTop: wp('2')},
    forgotTextStyle: {fontFamily: 'Poppins-Light',fontSize: wp('3'),color: 'white',textAlign: 'right',},
