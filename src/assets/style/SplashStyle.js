...
const SplashStyle = StyleSheet.create({
    ...
    secondViewStyle: {flex: 1, justifyContent: 'flex-end', alignItems: 'center', paddingBottom: wp('10')},
    ...
    sliderStyle:{width: wp('30'),height: wp('1.2'),borderRadius: wp('1'),backgroundColor: AppColor.white,marginTop: wp('3')},
